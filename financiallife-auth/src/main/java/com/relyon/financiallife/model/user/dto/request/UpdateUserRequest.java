...
@AllArgsConstructor
@Builder
@Schema(description = "Details for updating a user")
public class UpdateUserRequest {

    @NotBlank(message = "The firstName cannot be empty")
    @Size(min = 2, max = 30, message = "First name must be between {min} and {max} characters long")
    @Schema(description = "The first name of the user", example = "John", requiredMode = Schema.RequiredMode.REQUIRED, minLength = 2, maxLength = 30)
    private String firstName;

    @NotBlank(message = "The lastName cannot be empty")
    @Size(min = 2, max = 30, message = "Last name must be between {min} and {max} characters long")
    @Schema(description = "The last name of the user", example = "Doe", requiredMode = Schema.RequiredMode.REQUIRED, minLength = 2, maxLength = 30)
    private String lastName;

    @NotBlank(message = "The username cannot be empty")
    @Size(min = 2, max = 30, message = "Username must be between {min} and {max} characters long")
    @Schema(description = "The username of the user", example = "johndoe", requiredMode = Schema.RequiredMode.REQUIRED, minLength = 2, maxLength = 30)
    ...
    @Schema(description = "Whether the user account is enabled or not", example = "true", requiredMode = Schema.RequiredMode.REQUIRED, minLength = 4, maxLength = 5)
    @NotNull(message = "Enabled status cannot be null")
    private boolean isEnabled;

    @Schema(description = "The updated list of roles associated with the user", example = "[1, 2]")
